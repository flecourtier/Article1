...
def Run_laplacian2D(pde, bc_loss_bool=False, training = False, w_bc=0, w_res=1.0):
    print(current)
    ...
    file_name = current / "networks" / "test_fe1_v3.pth"
    new_training = False
    # new_training = True
    ...
    filename = current / "networks" / "test_fe1_v3.png"
...
if __name__ == "__main__":
    ...
    Run_laplacian2D(pde,training = False,bc_loss_bool=True,w_bc=10.0,w_res=1.0)